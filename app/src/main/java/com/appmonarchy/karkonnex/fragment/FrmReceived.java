...
public class FrmReceived extends Fragment {
    FrmReceivedBinding binding;
    Home activity;
    List<CarInfo> list;
    GridAdapter adapter;
    public FrmReceived() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FrmReceivedBinding.inflate(getLayoutInflater());
        init();
    ...
    private void getData(){
        ...
        activity.api.postData("inquiry_listing.php", builder.build()).enqueue(new Callback<JsonObject>() {
            @Override
