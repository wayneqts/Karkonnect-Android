...
import com.appmonarchy.karkonnex.adapter.MyCarAdapter;
import com.appmonarchy.karkonnex.databinding.FrmMyCarBinding;
...
public class FrmMyCar extends Fragment {
    public FrmMyCarBinding binding;
    Home activity;
    List<CarInfo> list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FrmMyCarBinding.inflate(getLayoutInflater());
        init();
    ...
    private void init(){
        ...
        adapter = new MyCarAdapter(activity, list, this);
    ...
    private void getData(){
        ...
        activity.api.postData("view_car.php", builder.build()).enqueue(new Callback<JsonObject>() {
            @Override
                        ...
                        if (jsData != null && jsData.length() > 0){
                            for (int i = 0;i < jsData.length();i++){
                                ...
                                if (json instanceof JSONObject){
                                    ...
                                    list.add(new CarInfo(jsCar.optString("id"), jsCar.optString("pid"), jsCar.optString("type"),  jsCar.optString("uid"),
