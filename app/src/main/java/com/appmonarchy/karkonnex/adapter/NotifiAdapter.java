...
import com.appmonarchy.karkonnex.activities.OtherUser;
import com.appmonarchy.karkonnex.databinding.ItemNotificationBinding;
import com.appmonarchy.karkonnex.model.Notifications;
...
public class NotifiAdapter extends RecyclerView.Adapter<NotifiAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        if (noti.getStt().equals("1")){
            ...
            Typeface regularFont = ResourcesCompat.getFont(activity, R.font.montserrat_regular);
            holder.bind.tvNotification.setTypeface(regularFont);
        }else {
            holder.bind.cvUnread.setVisibility(View.VISIBLE);
            Typeface boldFont = ResourcesCompat.getFont(activity, R.font.montserrat_bold);
